...
class DriveConstants {
  ...
  public static final ModuleConfig[] moduleConfigs = {
    ...
    ModuleConfig.builder()
        ...
        .driveMotorId(7)
        .encoderChannel(0)
        .encoderOffset(Rotation2d.fromRadians(0.16028737150729522).rotateBy(Rotation2d.kCCW_Pi_2))
    ...
    ModuleConfig.builder()
        ...
        .driveMotorId(3)
        .encoderChannel(1)
        .encoderOffset(Rotation2d.fromRadians(-0.1422097592800296).rotateBy(Rotation2d.kCCW_Pi_2))
        .driveGearing(mk4iDriveGearing)
        .turnGearing(mk4iTurnGearing)
        .turnInverted(true)
        .build(),
    ...
    ModuleConfig.builder()
        ...
        .driveMotorId(9)
        .encoderChannel(2)
        .encoderOffset(Rotation2d.fromRadians(-3.009554996093968).rotateBy(Rotation2d.kCCW_Pi_2))
        .driveGearing(mk4iDriveGearing)
        .turnGearing(mk4iTurnGearing)
        .turnInverted(true)
        .build(),
    ...
    ModuleConfig.builder()
        ...
        .driveMotorId(5)
        .encoderChannel(3)
        .encoderOffset(Rotation2d.fromRadians(2.559973505647124).rotateBy(Rotation2d.kCCW_Pi_2))
        .driveGearing(mk4iDriveGearing)
        .turnGearing(mk4iTurnGearing)
        .turnInverted(true)
        .build(),
