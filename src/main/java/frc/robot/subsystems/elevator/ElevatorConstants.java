...
public class ElevatorConstants {
  // Measured from CAD
  public static final double pivotToTunnelFront = Units.inchesToMeters(6.0); // TODO
  ...
  public static final Translation2d superstructureOrigin2d = new Translation2d(0.08939702, 0.12879159);
  ...
  public static final Translation2d dispenserOrigin2d = superstructureOrigin2d.plus(new Translation2d(dispenserToBottom + (stageThickness * 2) + slamBlockThickness, elevatorAngle));
  public static final Translation3d dispenserOrigin3d = new Translation3d(dispenserOrigin2d.getX(), 0.0, dispenserOrigin2d.getY());
