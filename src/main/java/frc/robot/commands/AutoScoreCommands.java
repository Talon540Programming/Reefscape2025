...
public class AutoScoreCommands {
  ...
  public static final LoggedTunableNumber[] ejectTimeSeconds = {
    ...
    return new DriveToPose(
        ...
        .until(
            () -> {
              ...
              Pose2d poseError = robot.get().relativeTo(goal.apply(coralObjectiveOpt.get()));

              int intReefLevel = coralObjectiveOpt.get().reefLevel().ordinal();
                ...
                .withDeadline(
                    Commands.waitUntil(elevatorBase::atGoal)
                        .andThen(
                            ...
                            dispenserBase
                                .runDispenser(
                                    () -> DispenserBase.getScoringVoltage(reefLevel.get()))
                                .until(
                                    () ->
