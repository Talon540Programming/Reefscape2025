...
public class AlertsUtil {
  ...
  private final Alert lowBatteryVoltageAlert = new Alert("Battery voltage is too low, change the battery", AlertType.kWarning);
  ...
  private final Alert ledsDisabledAlert = new Alert("LEDs Disabled by Override", AlertType.kInfo);
  private final Alert ledLowVoltageDisabledAlert = new Alert("LEDs disabled due to low battery voltage", AlertType.kWarning);
